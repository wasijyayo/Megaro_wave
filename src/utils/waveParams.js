...
export function getWaveParams(downlink) {
  ...
  return { amplitude, frequency, speed, turbulence, difficultyMultiplier, label, color }
}
 ...
 */
export function calcWaveTilt(amplitude, frequency, speed, turbulence, elapsedTime) {
  const t = elapsedTime
  const f = frequency
  const s = speed
  const A = amplitude
