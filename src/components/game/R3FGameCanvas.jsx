...
export default function R3FGameCanvas({ waveParams, personCanvas, onElapsedTime, calibratedRef, remoteVideoTrack = null }) {
  return (
    <Canvas
    ...
    >
      ...
      <BackgroundScene waveParams={waveParams} personCanvas={personCanvas} personTransform={PERSON_TRANSFORM} calibratedRef={calibratedRef} remoteVideoTrack={remoteVideoTrack} />
    </Canvas>
  )
}
