  ...
  return (
    ...
    >
      ...
      <View style={[s.content, isTablet && s.contentTablet]}>
        ...
        <TouchableOpacity
          style={s.selectBtn}
          onPress={() => navigation.navigate("WifiSelect")}
          activeOpacity={0.8}
        >
          <Text style={s.selectBtnText}>WiFi選択</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
const s = StyleSheet.create({
  ...
  selectBtnText: { color: "#7aadff", fontSize: 15, fontWeight: "700" },
});
